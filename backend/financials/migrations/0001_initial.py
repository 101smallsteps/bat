# Generated by Django 4.2 on 2024-02-17 02:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataFrequency', models.CharField(choices=[('Q_1', 'Quarterly_1'), ('Q_2', 'Quarterly_2'), ('Q_3', 'Quarterly_3'), ('Q_4', 'Quarterly_4'), ('A', 'Annual')], max_length=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symbol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vc_symbol', to='financials.symbol')),
            ],
        ),
        migrations.CreateModel(
            name='SymbolAnalysis',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('AnalysisStatus', models.CharField(choices=[('GOOD', 'good'), ('BAD', 'bad'), ('OK', 'ok')], max_length=6)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('symbol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='symbols_all', to='financials.symbol')),
            ],
        ),
        migrations.CreateModel(
            name='Ratio',
            fields=[
                ...
                ('financeInfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratios_financeInfo', to='financials.financedata')),
            ],
        ),
        migrations.CreateModel(
            name='Portfolio',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('metric', models.CharField(choices=[('REVENUE', 'Revenue'), ('DERATIO', 'DERatio')], max_length=20)),
                ('analysisResult', models.CharField(choices=[('GOOD', 'good'), ('BAD', 'bad'), ('OK', 'ok')], max_length=6)),
                ('metricDisplay', models.CharField(max_length=6)),
                ('symbol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='symbols_all_overall', to='financials.symbol')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('financeInfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='income_financeInfo', to='financials.financedata')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rank', models.IntegerField()),
                ('symbol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gc_symbol', to='financials.symbol')),
            ],
        ),
        migrations.AddField(
            model_name='financedata',
            name='symbol',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='findata_symbol', to='financials.symbol'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rank', models.IntegerField()),
                ('symbol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dc_symbol', to='financials.symbol')),
            ],
        ),
        migrations.CreateModel(
            name='CashFlow',
            fields=[
                ...
                ('financeInfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cashflow_financeInfo', to='financials.financedata')),
            ],
        ),
        migrations.CreateModel(
            name='BalanceSheet',
            fields=[
                ...
                ('TotalRevenue', models.FloatField(default=0, null=True)),
                ('OperatingRevenue', models.FloatField(default=0, null=True)),
                ('financeInfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='balancesheet_financeInfo', to='financials.financedata')),
            ],
        ),
    ]
